...
class RSSScraper(BaseScraper):
    ...
    async def _fetch_feed(
        ...
        try:
            ...
            # Fetch feed content. Some publishers (e.g. MIT News) reject
            # default Python/httpx user agents, so send a conservative
            # browser-like UA for RSS requests.
            headers = {
                "User-Agent": (
                    "Mozilla/5.0 (compatible; HorizonRSS/1.0; "
