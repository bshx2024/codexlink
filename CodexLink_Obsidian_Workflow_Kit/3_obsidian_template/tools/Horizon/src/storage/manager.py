...
class StorageManager:
    ...
    def __init__(self, data_dir: str = "data"):
        ...
        self.ci_reports_dir = self.data_dir / "ci-reports"
    ...
    def save_summary(self, markdown: str, date: str, language: str = "en") -> Path:
        """Save a daily summary markdown file.

        Args:
            markdown: Summary content in Markdown
    ...
    def save_daily_summary(self, date: str, markdown: str, language: str = "en") -> Path:
        """Alias for save_summary (backwards compatibility)."""
        return self.save_summary(markdown, date, language)

    def save_ci_report(self, briefing: str, date: str) -> Path:
        """Save a competitive intelligence briefing report.

        Args:
            briefing: CI briefing content in Markdown
            date: Date string (YYYY-MM-DD)

        Returns:
            Path to the saved file
        """
        filename = f"ci-briefing-{date}.md"
        filepath = self.ci_reports_dir / filename
